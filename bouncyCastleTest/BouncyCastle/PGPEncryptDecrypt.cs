...
namespace FileEncryptionTasks.Helpers.PGP
{
    public static class PGPEncryptDecrypt
    {
        ...
        internal static void EncryptFile(string inputFileName, string outputFileName, string recipientKeyFileName, object shouldArmor, object shouldCheckIntegrity)
        {
